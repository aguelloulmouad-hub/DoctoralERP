...
class ModifierPlanificationWizard(models.TransientModel):
    _name = 'modifier.planification.wizard'
    _description = 'Wizard pour modifier la planification de la soutenance'
